...
> Course: **[CS 1656 - Introduction to Data Science](http://cs1656.org)** (CS 2056) -- Spring 2026  
> Instructor: Alexandros Labrinidis  
> Teaching Assistants: Evangelos Karageorgos, Modhumonty Das
>
> Recitation #1: Intro to Python
> Released: January 15, 2026  
> **Due: January 20th, 2026**

### Description
This is the **first lab** for the CS 1656 -- Introduction to Data Science (CS 2056) class, for the Spring 2026 semester.
...
### def part7(self)
For this part, you must open the CSV file again, parse it using `csv.reader()`, iterate through the rows, and write every cell, one cell at a time, without spaces or anything, in the file `part7.txt`. The example above would be written as OneTwoThreeFour
...
* select "Recitation Lab #1" from the list of active assignments in Canvas
* follow the instructions to submit your assignment and have it automatically graded.

### What to submit
For this test assignment you only need to submit `task.py` to "Recitation Lab #1: Intro to Python" and see if you get all 100 points. In case of an error or wrong result, you can modify the file and resubmit it as many times as you want until the deadline of **Tuesday, January 20, 11:59 pm**.
